    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden p-6">
     <SplashCursorDemo/>
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-yellow-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
